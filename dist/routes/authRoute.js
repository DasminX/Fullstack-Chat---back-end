...
router.route("/register").post(authValidator, (0, catchAsync_1.catchAsync)(authController_1.registerHandler));
router.route("/login").post(authValidator, (0, catchAsync_1.catchAsync)(authController_1.loginHandler));
