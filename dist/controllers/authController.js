...
const registerHandler = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, validateErrors_1.validateErrors)(validationErrorArr, "Login has to be at least 8 characters long and password should contain of 8 characters (at least 1 uppercase, at least 1 number)", 422);
